...
- **킬 로그 / 킬 스트릭 / 사망 상자**: 모든 PvP 킬이 킬 피드로 브로드캐스트되고 DB에 기록됩니다. 5/10/20 연킬은 전체 공지됩니다. 사망 시 드롭 아이템은 바닥에 흩어지는 대신 사망 지점에 상자로 영구히 보관되며(자동으로 사라지지 않음), 팀 소속 여부와 상관없이 누구나 열어서 약탈할 수 있습니다.
